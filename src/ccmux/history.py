"""Message history viewing and pagination.

Core responsibilities:
  - Fetch and format session message history
  - Handle history pagination (older/newer navigation)
  - Support unread message catch-up
  - Update user read offsets

Key functions: send_history()
"""
...
from .ui_components import build_history_keyboard
